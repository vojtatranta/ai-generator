...
export const V0DocumentPage = memo(function V0DocumentPage({
  aiResults,
  prompt,
  onUploadFileAction,
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <div className="mt-1 flex">
                ...
                <Label
                  htmlFor="file-upload"
                  className="cursor-pointer bg-background flex flex-row items-center py-2 px-3 border border-muted-foreground rounded-l-md shadow-sm text-sm font-medium text-muted-foreground focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
                >
                ...
                <span className="flex-1 bg-background py-2 px-3 text-sm border border-l-0 border-muted-foreground rounded-r-md">
                  {fileToUpload
                    ? fileToUpload.name
